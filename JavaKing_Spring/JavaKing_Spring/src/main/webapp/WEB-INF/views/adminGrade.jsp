...
<body>
	...
	<form action="adminGrade.do" method="post">
	<div class="info">
		<div id="tabs" class="tab_menu_container">
	    	...
	    	<button class="tab_menu_btn" type="button" onclick="location='insertRegister.do'">등록금등록</button>
	  		<button class="tab_menu_btn on" type="button" onclick="location='adminGrade.do'">성적등록</button>
		...
		<div id="tables">
			<div class="container1">
				<table>
					...
					<tr>
						<td><label for="div취득학점" id="lbl취득학점" title="취득학점">취득점수</label></td>
						<td><input type="number" step="0.5" id="div취득학점" class="form-control" name="grade_getcredit" placeholder="ex)2.5, 3, 3.5"></td>
					</tr>
					<tr>
						<td><label for="div점수" id="lbl점수" title="점수">백분율점수</label></td>
						<td><input type="number" id="div점수" class="form-control" name="grade_score" placeholder="ex) 80,85,90"></td>
					</tr>
				</table>	      
