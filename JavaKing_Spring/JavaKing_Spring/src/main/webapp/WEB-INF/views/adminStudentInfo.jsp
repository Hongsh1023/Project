...
<body>
	...
	<form action="adminStudentInfo.do" method="post">
	<div class="info">
		<div id="tabs" class="tab_menu_container">
	   	 	<button class="tab_menu_btn on" type="button" onclick="location='adminStudentInfo.do'">기본정보등록</button>
	    	<button class="tab_menu_btn" type="button" onclick="location='insertRegister.do'">등록금등록</button>
		...
		<div id="tables">
			<div class="container1">
					...
					<input type="text" id="div성명" class="form-control" name="std_name" >
					
					<label for="div학과" id="lbl학과" title="학과">학과</label>
					<input type="text" id="div학과" class="form-control" name="std_major" >
					
					<label for="div학번" id="lbl학번" title="학번">학번</label>
					<input type="text" id="div학번" class="form-control" name="std_no" >
	        </div>
	        <div class="container2">   
					<label for="div성별" id="lbl성별" title="성별">성별</label>
	                <input type="text" id="div성별" class="form-control" name="std_gender">
	                
					<label for="div학년" id="lbl학년" title="학년">학년</label>
					<input type="text" id="div학년" class="form-control" name="std_level" >
					
					<label for="div학적상태" id="lbl학적상태" title="학적상태">학적상태</label>
					<input type="text" id="div학적상태" class="form-control" name="std_status">				
			</div>
	        <div class="container3">  		
					<label for="div생년월일" id="lbl생년월일" title="생년월일">생년월일</label>
	                <input type="date" id="div생년월일" class="form-control" name="std_birthday" >
	        
					<label for="div학기" id="lbl학기" title="학기">학기</label>
					<input type="text" id="div학기" class="form-control" name="std_semester" >
			
					<label for="div입학일" id="lbl입학일" title="입학일">입학일</label>
					<input type="date" id="div입학일" class="form-control" name="std_startdate" >
			</div> 	
			<div class="container4">  		
					<label for="div비밀번호" id="lbl비밀번호" title="비밀번호">비밀번호</label>
					<input type="text" id="div비밀번호" class="form-control" name="std_pwd" >
					
					<label for="div지도교수" id="lbl지도교수" title="지도교수">지도교수번호</label>
					<input type="number" id="div지도교수" class="form-control" name="pro_no" >
					
					<label for="div졸업일" id="lbl졸업일" title="졸업일">졸업일</label>
					<input type="date" id="div졸업일" class="form-control" name="std_enddate" value="0000-00-00">
			</div>
			<div class="container5">  		
					<label for="div이메일" id="lbl이메일" title="이메일">이메일</label>
					<input type="text" id="div이메일" class="form-control" name="std_email">
			</div>
			<div class="container6"> 		
					<label for="div특이사항" id="lbl특이사항" title="특이사항">특이사항</label>
	                <textarea rows="10" cols="100%" id="div특이사항" class="form-control" name="std_etc" ></textarea>
			</div>
