...
public class ClassregController {
	...
	public ModelAndView classregInsert(
		...
		ModelAndView mav = new ModelAndView("redirect:/login/classreg.do");
		return mav;
		
	}
	@RequestMapping(value="/login/classregDelete.do") //삭제뷰
	...
	@RequestMapping(value="/login/printClassreg.do") //삭제뷰
