...
public class GradeController {
	...
	@RequestMapping("/login/detailGrade.do")
	...
	@RequestMapping(value="/login/adminGrade.do", method=RequestMethod.GET)
	public void insertForm() {
	}
	
	@RequestMapping(value="/login/adminGrade.do", method=RequestMethod.POST)
	...
	@RequestMapping(value="/login/updateGrade.do", method=RequestMethod.GET)
	public void updateForm(int grade_no, Model model) {
		model.addAttribute("g", dao.findByNo(grade_no));
	}
	
	@RequestMapping(value="/login/updateGrade.do", method=RequestMethod.POST)
	...
	@RequestMapping(value="/login/deleteGrade.do", method = RequestMethod.GET)
	public void deleteForm(int grade_no, Model model) {
		model.addAttribute("grade_no",grade_no);
	}
	
	@RequestMapping(value="/login/deleteGrade.do", method = RequestMethod.POST)
	public ModelAndView deleteSubmit(int grade_no, Model model) {
		ModelAndView mav = new ModelAndView("redirect:/login/deleteGrade.do");
